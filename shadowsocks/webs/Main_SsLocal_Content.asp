...
<head>
  ...
  <title>软件中心 - 科学上网 - Socks5代理设置</title>
                ...
                <tr>
                  <td bgcolor="#4D595D" colspan="3" valign="top">
                    ...
                    <div class="SimpleNote">
                      <li>
                        <i>说明：</i>此页面允许配置第二个shadosocks账号，功能仅限于在路由器上打开一个连接到shadowsocks服务器的socks5端口。如果你使用chrome浏览器，你可以使用SwitchyOmega插件去连接这个socks5代理。
                      </li>
                    </div>
                    <div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img
                        src="/images/New_ui/export/line_export.png"></div>
                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"
                      ...
                      <tr>
                        ...
                        <td>
                          <input style="background-image: none;background-color: #576d73;border:1px solid gray"
                            type="text" class="input_ss_table" id="ss_local_server" name="ss_local_server"
                            maxlength="100" value="">
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <input type="text" class="input_ss_table" id="ss_local_port" name="ss_local_port"
                            maxlength="100" value="">
                        </td>
                      </tr>
                      <tr>
                        <th width="20%">密码</th>
                        <td>
                          <input type="password" class="input_ss_table" id="ss_local_password" name="ss_local_password"
                            maxlength="100" value="" onBlur="switchType(this, false);"
                      ...
                      <tr>
                        <th width="20%">加密方法</th>
                        <td>
                          <select id="ss_local_method" name="ss_local_method"
                            style="width:165px;margin:0px 0px 0px 2px;" class="input_option">
                      ...
                      <tr>
                        <th width="20%">超时时间</th>
                        <td>
                          <input type="text" class="input_ss_table" id="ss_local_timeout" name="ss_local_timeout"
                            maxlength="100" value="600">
                        </td>
                      </tr>
                      <tr>
                        <th width="20%">本地代理端口</th>
                        <td>
                          <input type="text" class="input_ss_table" id="ss_local_proxyport" name="ss_local_proxyport"
                            maxlength="100" value="1082">
                        </td>
                      </tr>
                      <tr id="ss_v2ray_plugin">
                        <th width="35%">v2ray-plugin</th>
                        <td>
                          <select id="ss_local_v2ray_plugin" name="ss_local_v2ray_plugin"
                      ...
                      <tr id="ss_v2ray_plugin_opts">
                        ...
                        <td>
                          <input type="text" name="ss_local_v2ray_plugin_opts" id="ss_local_v2ray_plugin_opts"
                            placeholder="tls;host=cloudfront.com" class="input_ss_table" maxlength="100"
                            value=""></input>
                        </td>
                      </tr>
                      <tr id="acl_support">
                        <th>ACL控制</th>
                        <td>
                          <select name="ss_local_acl" id="ss_local_acl" class="input_option"
